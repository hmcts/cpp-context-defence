...
public class OrganisationAccessHelper {
    ...
    public void sendCaseAssignedToOrganisationEvent(final String caseId,
                                                    final String assigneeUserId, final String assigneeOrgId,
                                                    final String assignorUserId, final String assignorOrgId) {
        final String updatePayload = getPayloadForCreatingRequest("stub-data/private-events/defence.events.case-assigned-to-organisation.json")
        ...
        try (final JMSTopicHelper jmsTopicHelper = new JMSTopicHelper()) {
            ...
            jmsTopicHelper.sendEventMessage("defence.events.case-assigned-to-organisation",
    ...
    public static void verifyOrganisationAssignedToTheTheCase(final String caseId, final String userId, final List<Matcher<? super ReadContext>> matchers) {
