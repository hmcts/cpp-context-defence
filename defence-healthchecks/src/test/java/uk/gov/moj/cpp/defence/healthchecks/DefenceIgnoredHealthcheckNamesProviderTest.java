...
public class DefenceIgnoredHealthcheckNamesProviderTest {


    @InjectMocks
    private DefenceIgnoredHealthcheckNamesProvider defenceIgnoredHealthcheckNamesProvider;

    @Test
    public void shouldIgnoreFileStoreAndJobStoreHealthchecks() throws Exception {

        final List<String> namesOfIgnoredHealthChecks = defenceIgnoredHealthcheckNamesProvider.getNamesOfIgnoredHealthChecks();
