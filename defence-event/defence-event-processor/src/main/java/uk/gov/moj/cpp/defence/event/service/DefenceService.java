...
public class DefenceService {
    ...
    public UUID getCaseIdForDefenceClient(final UUID defendantId, final Metadata metadata) {
        final JsonObject getDefenceClientForDefendantId = JsonObjects.createObjectBuilder().add("defendantId", defendantId.toString()).build();
    ...
    public JsonArray getDefendantsByLAAContractNumber(final JsonEnvelope envelope, final List<String> laaContractNumbers) {
        ...
        final JsonObject getDefendantsByLaaContractNumberRequest = JsonObjects.createObjectBuilder().add("laaContractNumbers", laaContractNumbersAsString).build();
    ...
    public JsonArray getPleaAndAllocationDetailsForACase(final Metadata metadata, final UUID caseId) {
        final JsonObject getDefendantsByLaaContractNumberRequest = JsonObjects.createObjectBuilder().add("caseId", caseId.toString()).build();
